...
const CarsSavedPage = () => {
  ...
  const [cars, setCars] = useState([
    {id: 1, img: carImg, name: '', price: '', mpg: '', hp: '', engine: '', transmission: '', weight: ''},
    {id: 2, img: carImg, name: '', price: '', mpg: '', hp: '', engine: '', transmission: '', weight: ''},
    {id: 3, img: carImg, name: '', price: '', mpg: '', hp: '', engine: '', transmission: '', weight: ''},
    {id: 4, img: carImg, name: '', price: '', mpg: '', hp: '', engine: '', transmission: '', weight: ''}
  ]);
      ...
      {cars.map((car) => ( 
          <car key = {car.id} className = "border-black m-[10px] border-[3px] flex flex-row p-[10px] justify-between items-center flex-wrap">
            <div>
              ...
              <img className = "w-[300px] h-auto" src = {car.img} alt = "car image"></img>
            </div>
            <p>Name: {car.name}</p>
            <p>Price: {car.price}</p>
            <p>MPG: {car.mpg}</p>
